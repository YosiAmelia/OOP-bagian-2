...
namespace OOPCollection2
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            {
            awal:
                Console.WriteLine("PILIH MENU DATA KARYAWAN\n");
                ...
                switch (menu)
                {
                    case 1:
                        ...
                        do
                        {
                            ...
                            Console.WriteLine("Silahkan pilih jenis karyawan yang ingin di input datanya ");
                            Console.WriteLine("\n[1] Karyawan Tetap");
                            Console.WriteLine("[2] Karyawan Harian");
                            Console.WriteLine("[3] Sales");
                            Console.WriteLine("[4] untuk kembali ke menu");
                    ...
                    case 2:
                        ...
                        Console.Write("Masukkan Nik Karyawan yang ingin di hapus datanya : ");
